...
public class CompareDataTypeTest
{
  ...
  public void testNull()
  {
    ...
    assertFalse(cNull.compare(UNoSQLSchemaFactory.eINSTANCE.createNull(), null));
    assertTrue(cNull.compare(UNoSQLSchemaFactory.eINSTANCE.createNull(), UNoSQLSchemaFactory.eINSTANCE.createNull()));
  }
