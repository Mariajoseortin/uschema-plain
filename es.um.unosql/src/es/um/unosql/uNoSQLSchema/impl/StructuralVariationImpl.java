 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.unosql.uNoSQLSchema.impl.StructuralVariationImpl#getVariationId <em>Variation Id</em>}</li>
 *   <li>{@link es.um.unosql.uNoSQLSchema.impl.StructuralVariationImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link es.um.unosql.uNoSQLSchema.impl.StructuralVariationImpl#getCount <em>Count</em>}</li>
 *   <li>{@link es.um.unosql.uNoSQLSchema.impl.StructuralVariationImpl#getFirstTimestamp <em>First Timestamp</em>}</li>
 *   <li>{@link es.um.unosql.uNoSQLSchema.impl.StructuralVariationImpl#getLastTimestamp <em>Last Timestamp</em>}</li>
 *   <li>{@link es.um.unosql.uNoSQLSchema.impl.StructuralVariationImpl#getContainer <em>Container</em>}</li>
 *   <li>{@link es.um.unosql.uNoSQLSchema.impl.StructuralVariationImpl#getLogicalFeatures <em>Logical Features</em>}</li>
 *   <li>{@link es.um.unosql.uNoSQLSchema.impl.StructuralVariationImpl#getStructuralFeatures <em>Structural Features</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructuralVariationImpl extends MinimalEObjectImpl.Container implements StructuralVariation {
	...
	protected EClass eStaticClass() {
		return UNoSQLSchemaPackage.Literals.STRUCTURAL_VARIATION;
	}
	...
	public void setVariationId(int newVariationId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UNoSQLSchemaPackage.STRUCTURAL_VARIATION__VARIATION_ID, oldVariationId, variationId));
	}
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<Feature>(Feature.class, this, UNoSQLSchemaPackage.STRUCTURAL_VARIATION__FEATURES);
		}
		return features;
	}
	...
	public void setCount(long newCount) {
		...
		count = newCount;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UNoSQLSchemaPackage.STRUCTURAL_VARIATION__COUNT, oldCount, count));
	}
	...
	public void setFirstTimestamp(long newFirstTimestamp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UNoSQLSchemaPackage.STRUCTURAL_VARIATION__FIRST_TIMESTAMP, oldFirstTimestamp, firstTimestamp));
	}
	...
	public void setLastTimestamp(long newLastTimestamp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UNoSQLSchemaPackage.STRUCTURAL_VARIATION__LAST_TIMESTAMP, oldLastTimestamp, lastTimestamp));
	}
	...
	public SchemaType getContainer() {
		if (eContainerFeatureID() != UNoSQLSchemaPackage.STRUCTURAL_VARIATION__CONTAINER) return null;
	...
	public NotificationChain basicSetContainer(SchemaType newContainer, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newContainer, UNoSQLSchemaPackage.STRUCTURAL_VARIATION__CONTAINER, msgs);
		return msgs;
	}
	...
	public void setContainer(SchemaType newContainer) {
		if (newContainer != eInternalContainer() || (eContainerFeatureID() != UNoSQLSchemaPackage.STRUCTURAL_VARIATION__CONTAINER && newContainer != null)) {
			...
			if (newContainer != null)
				msgs = ((InternalEObject)newContainer).eInverseAdd(this, UNoSQLSchemaPackage.SCHEMA_TYPE__VARIATIONS, SchemaType.class, msgs);
			msgs = basicSetContainer(newContainer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UNoSQLSchemaPackage.STRUCTURAL_VARIATION__CONTAINER, newContainer, newContainer));
	}
	...
	public EList<LogicalFeature> getLogicalFeatures() {
		if (logicalFeatures == null) {
			logicalFeatures = new EObjectResolvingEList<LogicalFeature>(LogicalFeature.class, this, UNoSQLSchemaPackage.STRUCTURAL_VARIATION__LOGICAL_FEATURES);
		}
	...
	public EList<StructuralFeature> getStructuralFeatures() {
		if (structuralFeatures == null) {
			structuralFeatures = new EObjectResolvingEList<StructuralFeature>(StructuralFeature.class, this, UNoSQLSchemaPackage.STRUCTURAL_VARIATION__STRUCTURAL_FEATURES);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UNoSQLSchemaPackage.STRUCTURAL_VARIATION__CONTAINER:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UNoSQLSchemaPackage.STRUCTURAL_VARIATION__FEATURES:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case UNoSQLSchemaPackage.STRUCTURAL_VARIATION__CONTAINER:
				return eInternalContainer().eInverseRemove(this, UNoSQLSchemaPackage.SCHEMA_TYPE__VARIATIONS, SchemaType.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UNoSQLSchemaPackage.STRUCTURAL_VARIATION__VARIATION_ID:
				return getVariationId();
			case UNoSQLSchemaPackage.STRUCTURAL_VARIATION__FEATURES:
				return getFeatures();
			case UNoSQLSchemaPackage.STRUCTURAL_VARIATION__COUNT:
				return getCount();
			case UNoSQLSchemaPackage.STRUCTURAL_VARIATION__FIRST_TIMESTAMP:
				return getFirstTimestamp();
			case UNoSQLSchemaPackage.STRUCTURAL_VARIATION__LAST_TIMESTAMP:
				return getLastTimestamp();
			case UNoSQLSchemaPackage.STRUCTURAL_VARIATION__CONTAINER:
				return getContainer();
			case UNoSQLSchemaPackage.STRUCTURAL_VARIATION__LOGICAL_FEATURES:
				return getLogicalFeatures();
			case UNoSQLSchemaPackage.STRUCTURAL_VARIATION__STRUCTURAL_FEATURES:
