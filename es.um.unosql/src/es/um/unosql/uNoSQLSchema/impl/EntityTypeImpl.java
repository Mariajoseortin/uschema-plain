 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.unosql.uNoSQLSchema.impl.EntityTypeImpl#isRoot <em>Root</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityTypeImpl extends SchemaTypeImpl implements EntityType {
	...
	protected EClass eStaticClass() {
		return UNoSQLSchemaPackage.Literals.ENTITY_TYPE;
	}
	...
	public void setRoot(boolean newRoot) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UNoSQLSchemaPackage.ENTITY_TYPE__ROOT, oldRoot, root));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UNoSQLSchemaPackage.ENTITY_TYPE__ROOT:
				return isRoot();
		}
