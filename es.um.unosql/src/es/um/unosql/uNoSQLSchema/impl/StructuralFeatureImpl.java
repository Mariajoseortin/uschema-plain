 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.unosql.uNoSQLSchema.impl.StructuralFeatureImpl#isOptional <em>Optional</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class StructuralFeatureImpl extends FeatureImpl implements StructuralFeature {
	...
	protected EClass eStaticClass() {
		return UNoSQLSchemaPackage.Literals.STRUCTURAL_FEATURE;
	}
	...
	public void setOptional(boolean newOptional) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UNoSQLSchemaPackage.STRUCTURAL_FEATURE__OPTIONAL, oldOptional, optional));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UNoSQLSchemaPackage.STRUCTURAL_FEATURE__OPTIONAL:
				return isOptional();
		}
