 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.unosql.uNoSQLSchema.impl.PTupleImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PTupleImpl extends DataTypeImpl implements PTuple {
	...
	protected EClass eStaticClass() {
		return UNoSQLSchemaPackage.Literals.PTUPLE;
	}
	...
	public EList<DataType> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<DataType>(DataType.class, this, UNoSQLSchemaPackage.PTUPLE__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UNoSQLSchemaPackage.PTUPLE__ELEMENTS:
